...
dbutils.widgets.text("experiment_name", "/srram-db-mlops-demo/srram-db-mlops-demo-experiment-test", label="MLflow experiment name")

# MLflow registered model name to use for the trained mode..
dbutils.widgets.text("model_name", "srram-db-mlops-demo-model-test", label="Model Name")
